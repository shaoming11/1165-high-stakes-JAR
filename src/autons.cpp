...
void default_constants(){
  ...
  chassis.set_turn_constants(8, .2, 0.009, 1.5, 15);
...
void grush_r() {
  // FINALS 3 11:04:10
  chassis.set_drive_constants(6, 8, 0, 100, 0); // first val can be 10 or 12
  //Doink.set(true);
  //Claw.set(true);
  task::sleep(250);
  chassis.drive_side_distance(7.75, 11, 20, 0, 150, 0, 20, 0, 150, 0); // derivative was 150
  //chassis.drive_distance(7.25, chassis.get_absolute_heading(), 8, 10, 1.5, 200, 5000, 20, 0, 150, 0, 0, 0, 0, 0);
  //Claw.set(false); // grab first goal
  //Doink.set(false);
  chassis.turn_to_angle(90);
  Claw.set(true);
  Doink.set(true);
  ...
  task::sleep(250);
  intake.spin(fwd, 12, volt);
  chassis.turn_to_angle(-150); // 2 stack ringa
  chassis.drive_distance(3);
  task::sleep(750);
  intake.stop();
...
void awp_solo_b() {
  ...
  */
  ...
  chassis.drive_distance(-3.5);
  //wallL.spinTo(-210, deg, false);
  //wallR.spinTo(-210, deg, false);
  chassis.turn_to_angle(-90);
  chassis.drive_distance(-4, chassis.get_absolute_heading(), 6);
  Clamp.set(1);
  intake.spin(fwd, 12, volt);
